...
class TimePickerManager internal constructor(
    ...
    init {
        ...
        println("INSIDE INIT HOUR == ${initialHour.toLong()} MINUTE == ${dateComponents.minute}")
...
//        datePicker.preferredDatePickerStyle = UITimePickerStyle.UIDatePickerStyleCompact
